...
class MainPersonalProductsAdapter(private val context :Context,private val fragmentManager: FragmentManager) :
    RecyclerView.Adapter<MainPersonalProductsAdapter.MainPersonalProductsViewHolder>() {
    //    private var dataList:List<ProductResponse> = emptyList()
    inner class MainPersonalProductsViewHolder(private val binding: ProductRvItemBinding) :
...
//                tvProductBrandName.text = productResponse.brandName
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MainPersonalProductsViewHolder {
        return MainPersonalProductsViewHolder(
    ...
    override fun onBindViewHolder(holder: MainPersonalProductsViewHolder, position: Int) {
