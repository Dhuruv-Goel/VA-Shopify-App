...
class MainWinterWearProductsAdapter(private val context: Context, private val fragmentManager: FragmentManager) :
    RecyclerView.Adapter<MainWinterWearProductsAdapter.MainWinterWearProductsViewHolder>() {

//    private var dataList:List<ProductResponse> = emptyList()
    inner class MainWinterWearProductsViewHolder(private val binding: ProductRvItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        @SuppressLint("SetTextI18n")
        fun bind(productResponse: ProductResponse) {
            binding.apply {
//                Glide.with(itemView).load(productResponse.images[0]).into(imageProductRvItem)
...
//                bundle.putString("categoryName", productResponse.categoryName)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MainWinterWearProductsViewHolder {
        return MainWinterWearProductsViewHolder(
    ...
    override fun onBindViewHolder(holder: MainWinterWearProductsViewHolder, position: Int) {
