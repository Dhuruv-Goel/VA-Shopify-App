...
class SearchAdapter(private val context:Context,private val fragmentManager: FragmentManager):
...
//    private var datalist: List<ProductResponse> = emptyList()
  ...
  inner  class SearchViewHolder(private val binding: ProductRvItemLargeBinding) :
